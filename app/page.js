    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-black tracking-tighter">SentLead</span>
        </div>
        <Link href="/login">
          <Button variant="outline" className="rounded-full px-8">Admin Login</Button>
        </Link>
      </nav>
      ...
      <section className="flex flex-col items-center justify-center pt-20 px-4 text-center">
        ...
        <p className="mt-6 text-slate-500 text-lg max-w-2xl">
          Scale your business with ReplyChat. Build rules, manage clients, and 
